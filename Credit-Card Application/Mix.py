...
egitim_giris, test_giris,egitim_cikis, test_cikis = train_test_split(giris_verileri,cikis, test_size=0.25, random_state=3)

#Standardizasyon
scaler = preprocessing.StandardScaler()
stdGiris = scaler.fit_transform(egitim_giris)
stdTest = scaler.transform(test_giris)
siniflandiricilar=[KNeighborsClassifier(n_neighbors=2), LogisticRegression(random_state=3), GaussianNB(), DecisionTreeClassifier()]
